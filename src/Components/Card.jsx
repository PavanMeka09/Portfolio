...
export const Card = (props) => {
  return (
    <div
      className="relative h-[15rem] w-[25rem] border-[1px] border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 transition-all duration-300 flex flex-col justify-evenly py-4 items-center rounded-xl px-4 gap-4 hover:border-gray-400 dark:hover:border-gray-600 hover:scale-[1.02] hover:shadow-lg dark:hover:shadow-gray-800/50"
    >
      <div className='w-[100%]'>
