  ...
  return (<>
    <div className='min-h-screen w-full py-16' id='projects'>
      ...
      <div className='flex items-center justify-center gap-20 flex-wrap px-4 sm:px-8 md:px-16 lg:px-24 xl:px-40'>
        <Card name="x00m" desc='Web Application to Video Conference, Live collaborative sketch and coding labs' stack={["nextJS", "TypeScript", "WebRTC", "PostGres", ".."]} github='https://github.com/PavanMeka09/x00m' img={test} />
